 ...
 */
public class LikeReactionsTab extends Fragment {
    ...
    public static LikeReactionsTab newInstance(List<ListReactions> reactions_instance) {
        reactions = reactions_instance;
        return new LikeReactionsTab();
    }

    public LikeReactionsTab(){}
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recycler_likes, container, false);
