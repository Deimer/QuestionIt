 ...
 */
public class AllReactionsTab extends Fragment {
    ...
    public static AllReactionsTab newInstance(List<ListReactions> reactions_instance) {
        reactions = reactions_instance;
        return new AllReactionsTab();
    }

    public AllReactionsTab(){}
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_recycler_sheet, container, false);
